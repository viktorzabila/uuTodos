...
module.exports = class Deploy {
  ...
  async process() {
    ...
    if (templateType.startsWith("uu5") && !this.config.get("skipExternalsDiscovery")) {
      ...
      let externalsApp = templateType === "uu5-lib" ? depProcessor.getExternals("app") : externals; // library needs also "app"-related settings when generating component demo page
      this.config.set({ externals, externalsApp });
    }
