...
class uuCloudDeployTask {
  ...
  async _waitForResult(taskUri) {
    ...
    try {
      ...
      throw new Error("The check of deployment status failed. However, deployment is most likely still running and you can check the status in activity that was sent to you in Plus4U."
        + endOfLine + e.message)
    }
