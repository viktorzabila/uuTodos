...
if (uri.substr(-floatingVersion.length) === floatingVersion) uri = uri.substr(0, uri.length - floatingVersion.length) + "/1.3.0/";
__webpack_require__.p = uri;
module.exports = __webpack_require__(3);
var ex = module.exports;

if (ex && _typeof(ex) === "object") {
  if (!("version" in ex)) ex.version = "1.3.0";
  if (!("name" in ex)) ex.name = "uu5g05-browser-compatibility".split(/[\/\\]/).pop();
  if (!("namespace" in ex)) ex.namespace = "Uu5BrowserCompatibility";
}
...
function doCheck() {
  var envConfig;
  if (window.uu5Environment) envConfig = window.uu5Environment.browserUpdate;else if (window.UU5 && window.UU5.Environment) envConfig = window.UU5.Environment.browserUpdate; // https://github.com/browser-update/browser-update/wiki/Details-on-configuration
