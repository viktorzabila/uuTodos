...
exports.default = exports.cleanupErrorStack = exports.Tools = void 0;
...
var Tools = {
  ...
  renderHook: function renderHook(hook) {
    ...
    var _Tools$initHookRender = Tools.initHookRenderer.apply(Tools, [hook].concat(initialHookParams)),
        ...
        result = _objectWithoutProperties(_Tools$initHookRender, _excluded);
