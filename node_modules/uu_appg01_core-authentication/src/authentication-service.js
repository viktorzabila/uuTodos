...
class AuthenticationService {
   ...
   * @throws {AuthenticationError} In case authentication fails.
   */
  static async authenticateSystemIdentity(scope = null) {
    let realization = AuthenticationService.get();
    if (scope) {
      return await realization.authenticateSystemIdentity(scope);
    } else {
      return await realization.authenticateSystemIdentity();
    }
  }
