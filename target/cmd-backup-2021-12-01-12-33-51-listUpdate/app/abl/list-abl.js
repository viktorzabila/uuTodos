...
class ListAbl {
  ...
  //   const awid = uri.getAwid();
  //   // HDS 1 - validation
  //   const validationResult = this.validator.validate("foodUpdateDtoInType", dtoIn);
  //   uuAppErrorMap = ValidationHelper.processValidationResult(
  //     dtoIn,
  //     validationResult,
  ...
  //   let uuFood = await this.dao.get(awid, dtoIn.id)
  //   if(!uuFood){
  //     throw Errors.Update.UpdateDoesNotExist({ uuAppErrorMap }, { tema: dtoIn.id })
  //   }

  //   // HDS 3 - update
  //   try {
  //     uuFood = await this.dao.update(uuObject);
  //   } catch (err) {
